...
window = tk.Tk()
window.title("Hệ thống điểm danh nhận diện khuôn mặt")
...
def manually_fill():
    ...
    def fill_attendance():
        ...
        global subb
        subb=SUB_ENTRY.get() # get name subject
        ...
        try:
            global cursor
            connection = pymysql.connect(host='localhost', user='root', password='123456', db='manually_fill_attendance')
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                csv_name='H:/Pycharm/FAMS-Face/Attendance/Manually Attendance/'+ DB_table_name+ '.csv'
            ...
            def attf():
                ...
                subprocess.Popen(
                    r'explorer /select,"H:\Pycharm\FAMS-Face\Attendance\Manually Attendance\-------Check atttendance-------"')
    ...
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    global cursor
                    connection = pymysql.connect(host='localhost', user='root', password='123456', db='Face_reco_fill')
                    cursor = connection.cursor()
                except Exception as e:
                    print(e)
                ...
                cs = 'H:/Pycharm/FAMS-Face/' + fileName
    ...
    def log_in():
        ...
        if username == 'admin' :
            if password == '123456':
                ...
                cs = 'H:/Pycharm/FAMS-Face/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
